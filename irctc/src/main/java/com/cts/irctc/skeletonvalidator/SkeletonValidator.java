...
public class SkeletonValidator 
{
	...
	public SkeletonValidator() 
	{
		...
		validateMethodSignature(
				"showTicketBookingForm:java.lang.String,getCarSearchResultForm:java.lang.String,populateFromCities:java.util.List,populateToCities:java.util.List,populateClassType:java.util.List",
